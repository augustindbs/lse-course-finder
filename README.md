...
The `preprocessing.py` file allows for course **content data to be saved in a Pickle (.pkl) file, in binary format**, so as to significantly speed up keyword search.
